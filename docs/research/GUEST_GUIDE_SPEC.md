...
Ejemplo de qué mostrar: “1. Busca la puerta gris junto a la farmacia. 2. Introduce el código. 3. Gira el pomo hacia arriba. 4. Si no funciona tras dos intentos, llama al contacto de acceso.” citeturn24search0turn35search5turn6view5turn36search1
...
Ejemplo de qué mostrar: “Wi‑Fi — Red: CasaAzul_5G — Contraseña: copiar”; “Calefacción — Termostato en salón — guía de 3 pasos”; “Basura — orgánico en cubo verde — vidrio en contenedor callejero”. citeturn9search1turn9search14turn39search0turn6view0
...
Ejemplo de qué mostrar: “Cocina — horno, inducción, cafetera, lavavajillas — no usar estropajo en isla de mármol”. La organización por espacio reduce ambigüedad mejor que una lista plana de amenities. citeturn12view1turn6view4turn27view0
...
Ejemplo de qué mostrar: “Lavadora — 1. Pulsa Power. 2. Programa 40°. 3. Añade detergente en cajetín II. 4. No usar secadora tras las 22:00”. citeturn27view0turn6view4turn6view5
...
Ejemplo de qué mostrar: “Silencio exterior: 22:00–08:00”; “Piscina: 09:00–21:00”; “No invitados no registrados”. citeturn24search2turn24search3turn14search11turn9search16
...
Ejemplo de qué mostrar: “Desayuno cerca — Café Norte — 6 min a pie — abre 07:30 — ideal para niños”. citeturn6view4turn6view5turn25view1turn27view0turn36search0
...
Ejemplo de qué mostrar: “No hay calefacción — comprueba termostato — si aparece E1, reinicia con el botón lateral — si no vuelve, llama al soporte técnico”. Esto sirve al huésped y también entrena a la IA. citeturn25view2turn26search2turn7view5
...
Ejemplo de qué mostrar: “Antes de irte: 1. Saca tu basura. 2. Deja toallas usadas en la ducha. 3. Cierra ventanas. 4. Pulsa Lock al salir”. citeturn24search1turn37search5
...
**ai** debe incluir todo lo de guest más `aiNotes`, pasos de diagnóstico, criterios de excepción, sinónimos, restricciones, estado de confianza, y rutas de escalado. Enso, Hostfully y Duve convergen en la misma idea: la IA es útil cuando responde con datos del PMS/guía/políticas y cuando deja rastro de la fuente o del razonamiento operativo. citeturn25view0turn25view2turn36search5
...
**Búsqueda universal** como primer mecanismo de recuperación. Si el huésped piensa “Wi‑Fi” y tarda más de un segundo en deducir dónde está, ya has perdido. Touch Stay y el discurso de varias reseñas/foros apuntan precisamente a “one searchable place”. citeturn40view0turn39search6
...
**TOC sticky corta** para navegación semántica: Llegada, Casa, Normas, Local, Ayuda, Salida. En páginas largas, NN/g avala accordions y estructuras de progressive disclosure en móvil, pero avisa de que deben usarse con buena señalización y sin desorientar. citeturn29search3turn29search11turn29search15
...
Un huésped no quiere explorar tu taxonomía; quiere resolver una microtarea. Cada patrón debe responder a eso. citeturn40view6turn25view1turn36search2turn29search13
...
La ausencia de información explícita genera mensajes; una ausencia bien diseñada reduce fricción. Airbnb además insiste en divulgar restricciones y disponibilidad real de amenities. citeturn24search3
...
Esta interacción debe existir y estar arriba. Si un huésped busca una contraseña, escribirla a mano en 2026 ya es castigo corporal UX. La evidencia cualitativa de foros y reportes apunta a que Wi‑Fi sigue siendo uno de los top asks. citeturn9search14turn39search0
...
**Direcciones y mapas.**  
Cada punto local y el propio alojamiento deben ofrecer “Abrir en Maps”. Hostfully enfatiza Google/Apple Maps y Duve vende guest app con acceso directo a información local. citeturn40view6turn36search0

**Issue reporting estructurado.**  
El patrón de Breezeway es muy bueno: dejar que el huésped reporte un problema desde la guía y convertirlo en tarea. Esto añade valor real porque une experiencia de huésped y operación. Debe implementarse al menos para “no puedo entrar”, “no hay agua caliente”, “no funciona calefacción/AC”, “ruido”, “limpieza”. citeturn7view5turn26search2turn26search10

**Modo offline / conexión lenta.**  
La guía debe mantener funcional el shell, el bloque esencial, los textos críticos y miniaturas de acceso cuando la conexión falle. Touch Stay comercializa explícitamente uso offline; en vuestro stack, eso se traduce en PWA + service worker + caché del contenido crítico. citeturn40view1turn31view0

**Instalar en pantalla de inicio.**  
No hace falta convertir esto en una app nativa para que parezca una buena app. Next.js documenta PWA con manifest, service worker y Add to Home Screen; Duve y Enso ya explotan patrones “boarding pass / guest app / wallet”. Recomiendo ofrecerlo solo después del primer valor real, no en el primer segundo de la visita. citeturn31view0turn36search2turn7view1

**Sugerencias dinámicas de etapa.**  
Una innovación de alto valor y bajo humo es cambiar la prioridad visual según momento: antes de llegar, enseñar Llegada; durante la estancia, Equipamiento y Local; la noche anterior, Salida. Esto ya está implícito en checkout cards, boarding passes y mensajes programados del mercado. citeturn24search1turn25view0turn7view1

## Métricas de éxito

La guía funciona si reduce mensajes repetitivos, baja el tiempo de resolución y aumenta autoservicio útil. Las métricas mínimas para host/operator deben ser estas:

**Open rate pre-arrival.**  
Porcentaje de reservas que abren la guía antes del check-in.

**Section reach crítica.**  
Porcentaje de sesiones que ven Llegada, Wi‑Fi, Normas y Salida.

**Self-service resolution rate.**  
Consultas resueltas sin intervención humana, especialmente acceso, Wi‑Fi, parking y checkout. Touch Stay, Hostfully y Enso venden precisamente reducción de preguntas repetitivas o respuestas automáticas basadas en guía. citeturn6view0turn25view0turn25view2

**Search success rate.**  
Búsquedas con clic útil y búsquedas sin resultado. Si “wifi”, “parking”, “heater”, “trash” o “checkout” fallan, tienes deuda UX clarísima.

**Issue deflection y issue routing.**  
Cuántas incidencias se previenen con guía; cuántas se abren desde guía y cuánto tardan en asignarse/resolverse.

**Checkout compliance.**  
Late checkouts, olvidos de llaves, basura fuera de sitio, ventanas abiertas. Esta es una métrica operativa, pero la guía la afecta mucho. citeturn37search5

**Language usage y fallback quality.**  
Idioma elegido, secciones con cambio de idioma, tasa de salida por idioma y consultas a soporte por traducción confusa.

**Guide contribution to revenue.**  
CTR en upsells o servicios adicionales cuando existan. Hostfully, Enso, Duve, Breezeway y Chekin demuestran que la guía ya no es solo soporte; también es canal comercial, con distinta ambición según producto. citeturn6view4turn7view1turn36search3turn26search2turn35search0