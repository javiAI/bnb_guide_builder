...
Ejemplos: Wi‑Fi, parking, cómo entrar, calefacción, basura, checkout. Esto es el pan de cada día, reduce carga operativa y tiene bajo riesgo cuando la fuente es fiable. En Enso, estos temas son precisamente los candidatos a auto-send; Breezeway y Hostfully orientan la guía y la IA a reducir back-and-forth en cuestiones repetitivas. citeturn25view2turn25view0turn26search6

**Triage de incidencias durante la estancia.**  
Ejemplos: no funciona calefacción, no hay agua caliente, no abre la cerradura, ruido, limpieza. La IA debe diagnosticar, guiar y decidir si escalar. Breezeway muestra el patrón más operativo: issue desde la guía que se convierte en tarea. Enso añade evaluación de elegibilidad, confianza y routing. citeturn7view5turn25view2

**Mensajería automática por etapa.**  
Confirmación, pre-arrival, day-of-arrival, mid-stay, nudge de checkout. Hostfully y Hostaway documentan plantillas, variables y automatización por momentos del journey. citeturn25view0turn26search3turn24search1

### P1

**Mensaje de bienvenida personalizado.**  
Con nombre, duración, motivo del viaje si existe, idioma, amenities relevantes y próximo hito. Duve y Enso explotan personalización basada en pre-check-in, PMS y segmentación. citeturn36search0turn7view1

**Upselling contextual.**  
Early check-in, late checkout, transporte, experiencias, limpieza extra. Debe estar estrictamente condicionado por política, inventario y ventana temporal. Chekin, Hostfully, Duve y Enso insisten bastante en esto. citeturn35search0turn6view4turn36search3turn7view1

**Copiloto para host y operaciones.**  
Draft de respuestas, resumen de conversación, recomendación de siguiente acción, y briefings para limpieza o mantenimiento. Duve ya expone “sources” en respuestas IA; Enso describe logging, confidence y approval loops. citeturn36search5turn25view2
...
Eso permite responder “¿dónde está el Wi‑Fi?” con un chunk minúsculo, sin arrastrar media guía; pero también permite recuperar contexto de sección si la pregunta es vaga o compuesta. Anthropic recomienda chunking por heading/subheading para el pipeline más simple, y OpenAI recomienda dividir textos largos en chunks en vez de truncarlos. citeturn18view5turn18view3
...
Esto ayuda mucho cuando el chunk, aislado, sería ambiguo. Anthropic reporta mejoras claras en retrieval con este enfoque, especialmente combinado con reranking. citeturn18view4
