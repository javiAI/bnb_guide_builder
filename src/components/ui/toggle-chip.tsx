...
// Chip silhouette + states, exported so sibling chip-shaped controls (e.g.
// free-tag chips) can't drift from ToggleChip's look.
...
export function ToggleChip({
  ...
  return (
    <button
      ...
      onClick={onToggle}
      className={cn(CHIP_BASE_CLASS, active ? CHIP_ACTIVE_CLASS : CHIP_INACTIVE_CLASS, className)}
    >
