...
export function OptionTile({ selected, label, description, recommended, showRecommended, children }: OptionTileProps) {
  return (
    <label
      className={cn(
        "relative flex min-h-[44px] cursor-pointer flex-col gap-0.5 rounded-[var(--radius-lg)] border-2 p-3 transition-colors focus-within:ring-2 focus-within:ring-[var(--color-border-focus)]",
        selected
