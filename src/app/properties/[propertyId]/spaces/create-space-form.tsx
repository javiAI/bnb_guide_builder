...
import { spaceTypes, getItems } from "@/lib/taxonomy-loader";

const spaceTypeOptions = getItems(spaceTypes);

interface CreateSpaceFormProps {
  propertyId: string;
}

export function CreateSpaceForm({ propertyId }: CreateSpaceFormProps) {
