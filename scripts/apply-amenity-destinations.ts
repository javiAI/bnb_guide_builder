...
export const DESTINATIONS: ReadonlyArray<AmenityDestinationEntry> = [
  ...
  { id: "am.outdoor_playground", destination: "derived_from_space", note: "Fijo/instalación del espacio — respaldado por sf.garden_children_play (flip 16I-6, FUTURE §29.7)." },
  ...
  { id: "am.outdoor_dining_area", destination: "derived_from_space", note: "Fijo/instalación del espacio — respaldado por sf.outdoor_dining (flip 16I-6, FUTURE §29.7)." },
  { id: "am.outdoor_furniture", destination: "derived_from_space", note: "Fijo/instalación del espacio — respaldado por sf.outdoor_furniture (flip 16I-6, FUTURE §29.7)." },
  ...
  { id: "am.sun_loungers", destination: "derived_from_space", note: "Fijo/instalación del espacio — respaldado por sf.sun_loungers (flip 16I-6, FUTURE §29.7)." },
