 ...
 *
 * Usage:
 *   npx tsx scripts/apply-amenity-destinations.ts
 *   # or compile + run:
 *   npx tsc scripts/apply-amenity-destinations.ts --outDir .tmp && node .tmp/scripts/apply-amenity-destinations.js
 *
...
export interface AmenityDestinationEntry {
  ...
  target?: string;
  /** Human-readable migration note from the audit table. Not written to the taxonomy JSON — only to the summary snapshot. */
  note?: string;
}
...
export const DESTINATIONS: ReadonlyArray<AmenityDestinationEntry> = [
  ...
  { id: "am.kitchen", destination: "derived_from_space", note: "Derivado de espacios/features (no se captura en PropertyAmenity)." },
  ...
  { id: "am.bathtub", destination: "derived_from_space", note: "Derivado de espacios/features (no se captura en PropertyAmenity)." },
  { id: "am.bidet", destination: "derived_from_space", note: "Derivado de espacios/features (no se captura en PropertyAmenity)." },
  { id: "am.body_soap", destination: "derived_from_space", note: "Derivado de espacios/features (no se captura en PropertyAmenity)." },
  { id: "am.cleaning_products", destination: "amenity_configurable", note: "Amenity configurable (inventario/experiencia)." },
  { id: "am.conditioner", destination: "derived_from_space", note: "Derivado de espacios/features (no se captura en PropertyAmenity)." },
  { id: "am.hair_dryer", destination: "derived_from_space", note: "Derivado de espacios/features (no se captura en PropertyAmenity)." },
  ...
  { id: "am.outdoor_shower", destination: "derived_from_space", note: "Derivado de espacios/features (no se captura en PropertyAmenity)." },
  { id: "am.shampoo", destination: "derived_from_space", note: "Derivado de espacios/features (no se captura en PropertyAmenity)." },
  { id: "am.shower_gel", destination: "derived_from_space", note: "Derivado de espacios/features (no se captura en PropertyAmenity)." },
  { id: "am.bed_linens", destination: "amenity_configurable", note: "Amenity configurable (inventario/experiencia)." },
  { id: "am.clothing_storage", destination: "derived_from_space", note: "Derivado de espacios/features (no se captura en PropertyAmenity)." },
  ...
  { id: "am.hangers", destination: "derived_from_space", note: "Derivado de espacios/features (no se captura en PropertyAmenity)." },
  { id: "am.mosquito_net", destination: "derived_from_space", note: "Derivado de espacios/features (no se captura en PropertyAmenity)." },
  { id: "am.room_darkening_shades", destination: "derived_from_space", note: "Derivado de espacios/features (no se captura en PropertyAmenity)." },
  { id: "am.safe", destination: "derived_from_space", note: "Derivado de espacios/features (no se captura en PropertyAmenity)." },
  ...
  { id: "am.dedicated_workspace", destination: "derived_from_space", note: "Derivado de espacios/features (no se captura en PropertyAmenity)." },
  ...
  { id: "am.dining_table", destination: "derived_from_space", note: "Derivado de espacios/features (no se captura en PropertyAmenity)." },
  ...
  { id: "am.beach_access", destination: "moved_to_property_attribute", note: "Es atributo de ubicación/entorno; debe vivir en Property (y/o propertyEnvironment)." },
  { id: "am.lake_access", destination: "moved_to_property_attribute", note: "Es atributo de ubicación/entorno; debe vivir en Property (y/o propertyEnvironment)." },
  ...
  { id: "am.private_entrance", destination: "moved_to_property_attribute", target: "Property.hasPrivateEntrance", note: "Es atributo estructural de privacidad/acceso, no equipamiento." },
  { id: "am.resort_access", destination: "moved_to_property_attribute", note: "Es atributo de ubicación/entorno; debe vivir en Property (y/o propertyEnvironment)." },
  { id: "am.ski_in_out", destination: "moved_to_property_attribute", note: "Es atributo de ubicación/entorno; debe vivir en Property (y/o propertyEnvironment)." },
  { id: "am.waterfront", destination: "moved_to_property_attribute", note: "Es atributo de ubicación/entorno; debe vivir en Property (y/o propertyEnvironment)." },
  ...
  { id: "am.free_parking_premises", destination: "moved_to_access", target: "parking_options", note: "Se modela como opción de parking en Access (parking_options), no como amenity." },
  { id: "am.free_street_parking", destination: "moved_to_access", target: "parking_options", note: "Se modela como opción de parking en Access (parking_options), no como amenity." },
  ...
  { id: "am.paid_parking_off_premises", destination: "moved_to_access", target: "parking_options", note: "Se modela como opción de parking en Access (parking_options), no como amenity." },
  { id: "am.paid_parking_on_premises", destination: "moved_to_access", target: "parking_options", note: "Se modela como opción de parking en Access (parking_options), no como amenity." },
  { id: "am.pool", destination: "derived_from_space", note: "Derivado de espacios/features (no se captura en PropertyAmenity)." },
  ...
  { id: "am.single_level_home", destination: "moved_to_access", target: "accessibility_features", note: "Es atributo de accesibilidad (no equipamiento)." },
  { id: "ax.step_free_guest_entrance", destination: "moved_to_access", note: "Este item es un accessibility_feature (ax.*) y debe capturarse en Acceso/Accesibilidad, no como amenity." },
  { id: "ax.guest_entrance_wide_81cm", destination: "moved_to_access", note: "Este item es un accessibility_feature (ax.*) y debe capturarse en Acceso/Accesibilidad, no como amenity." },
  { id: "ax.accessible_parking_spot", destination: "moved_to_access", note: "Este item es un accessibility_feature (ax.*) y debe capturarse en Acceso/Accesibilidad, no como amenity." },
  { id: "ax.step_free_path_to_entrance", destination: "moved_to_access", note: "Este item es un accessibility_feature (ax.*) y debe capturarse en Acceso/Accesibilidad, no como amenity." },
  { id: "ax.step_free_bedroom_access", destination: "moved_to_access", note: "Este item es un accessibility_feature (ax.*) y debe capturarse en Acceso/Accesibilidad, no como amenity." },
  { id: "ax.bedroom_entrance_wide_81cm", destination: "moved_to_access", note: "Este item es un accessibility_feature (ax.*) y debe capturarse en Acceso/Accesibilidad, no como amenity." },
  { id: "ax.step_free_bathroom_access", destination: "moved_to_access", note: "Este item es un accessibility_feature (ax.*) y debe capturarse en Acceso/Accesibilidad, no como amenity." },
  { id: "ax.bathroom_entrance_wide_81cm", destination: "moved_to_access", note: "Este item es un accessibility_feature (ax.*) y debe capturarse en Acceso/Accesibilidad, no como amenity." },
  { id: "ax.shower_grab_bar", destination: "moved_to_access", note: "Este item es un accessibility_feature (ax.*) y debe capturarse en Acceso/Accesibilidad, no como amenity." },
  { id: "ax.toilet_grab_bar", destination: "moved_to_access", note: "Este item es un accessibility_feature (ax.*) y debe capturarse en Acceso/Accesibilidad, no como amenity." },
  { id: "ax.step_free_shower", destination: "moved_to_access", note: "Este item es un accessibility_feature (ax.*) y debe capturarse en Acceso/Accesibilidad, no como amenity." },
  { id: "ax.shower_bath_chair", destination: "moved_to_access", note: "Este item es un accessibility_feature (ax.*) y debe capturarse en Acceso/Accesibilidad, no como amenity." },
  { id: "ax.ceiling_mobile_hoist", destination: "moved_to_access", note: "Este item es un accessibility_feature (ax.*) y debe capturarse en Acceso/Accesibilidad, no como amenity." },
];
