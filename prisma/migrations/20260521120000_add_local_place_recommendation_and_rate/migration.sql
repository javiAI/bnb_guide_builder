...
-- (paid parking, transit fares). Shape:
--   { amount: number, currency: "EUR"|"USD"|..., per: "hour"|"day"|"month", note?: string }
-- Kept separate from `provider_metadata` so provider-emitted data and
-- operator configuration remain cleanly partitioned.
